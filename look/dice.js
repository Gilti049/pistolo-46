...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-ee16ab3b');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-ee16ab3b');}
...
function clearFlash(){dieView.classList.remove('rl-win-ee16ab3b');dieView.classList.remove('rl-lose-ee16ab3b');if(frameEl){frameEl.classList.remove('rl-win-ee16ab3b');frameEl.classList.remove('rl-lose-ee16ab3b');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-ee16ab3b');if(frameEl){frameEl.classList.add('rl-win-ee16ab3b');}}else{dieView.classList.add('rl-lose-ee16ab3b');if(frameEl){frameEl.classList.add('rl-lose-ee16ab3b');}}
...
var brandEl=document.querySelector('.rl-brand-ee16ab3b');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
